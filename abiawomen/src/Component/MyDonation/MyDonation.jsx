  ...
  return (
    <div className='mx-10 my-10'>
      ...
      <div className='flex flex-row items-center justify-center my-5'> 
        <select name="Select Month" className='mx-5 py-5 px-10 border rounded-lg'>
          <option value="January">January</option>
          <option value="February">February</option>
          <option value="March">March</option>
          <option value="All Time">All Time</option>
        </select>
        <button className='bg-green-800 py-5 px-10 rounded-lg text-white'
        onClick={() => navigate('/MakeDonation')}>Make a Donation</button>
      </div>
      ...
      <div>
        ...
        {!loading && !error && donations.map(donation => (
          <div key={donation.id} className='border-b-2 border-black flex flex-row justify-between my-2'> 
