...
export default function EventsGallery() {
  return (
    <div className="px-10">
      <div>
        <h1 className="text-3xl font-bold py-5 text-[#194911]">
        ...
        <div className="w-full md:w-1/2 md:pl-10 mt-10 md:mt-0">
          <div className="p-10 my-12 bg-[#F2E3C4]">
            <div>
              ...
              <p className="my-5">
                The support from AWA has transofrmed me to pursue my dreams
              </p>
            </div>
            <p>Fatima O.</p>
          </div>
          ...
          <button className="w-full bg-[#E02B2B] text-white px-4 py-2 rounded my-5">
            See More Stories
          </button>
        </div>
      </div>
