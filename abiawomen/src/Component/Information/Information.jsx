  ...
  return (
    <div className='flex flex-col mx-10 my-10 px-20'>
        <div className='flex flex-col justify-center'>
            ...
            <p className='text-sm'>Abia Women Assembly is dedicated to advocating for the empowerment and growth of women in our communities.</p>
        </div>
        <div>
            <div className="flex flex-col md:flex-row gap-3 my-10">
                ...
                <p className="text-black text-center">Building confidence and skills for personal growth</p>
                </div>
                ...
                <p className="text-black text-center">Continuous development and achievement</p>
                </div>
                ...
                <p className="text-black text-center">Supportive network for shared success</p>
                </div>
            </div>
        </div>
