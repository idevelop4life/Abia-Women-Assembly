...
export default function SignIn() {
  ...
  return (
    <div className='mx-20'>
        <h1 className='text-4xl font-bold text-black text-center my-5'>Register</h1>
        <div className='border px-10 py-5 rounded-2xl'>
            <h2 className='text-sm font-bold text-gray-900 text-left'>Sign Up As</h2>
            <div className="flex flex-row justify-evenly ">
                
                <div className="">
                    <input id="member" name="role" type="radio" checked />
                    <label htmlFor="member">Member</label>
                </div>
                <div className="">
                    <input id="donor" name="role" type="radio" checked />
        ...
        <div className='my-5'>
            <h2 className='my-5'>Full Name</h2>
            <input type="text" placeholder='Enter your full name' className='border border-gray-300 rounded px-4 py-2 w-full' />
        </div>
        <div className='my-5'>
            <h2 className='my-5'>Email or Phone Number</h2>
            <input type="text" placeholder='Enter your email or phone number' className='border border-gray-300 rounded px-4 py-2 w-full' />
        </div>
        <div className='my-5'>
