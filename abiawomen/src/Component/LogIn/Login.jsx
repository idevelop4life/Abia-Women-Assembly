...
export default function Login() {
  return (
    <div className='mx-12'>
        <h1 className='text-center font-bold my-2 text-xl'>Log in</h1>
        <div> 
            <input type="text" placeholder='Email or Phone' className='border border-gray-300 rounded px-4 py-2 w-full my-5'/>
            <input type="text" placeholder='Password' className='border border-gray-300 rounded px-4 py-2 w-full'/>
        </div>
        <button className='bg-green-950 w-full my-5 text-white py-2 rounded-md'>Log in</button>
        <p className='text-center'>Forgot Password</p>
        <p className='text-center'>Don't have an account? <a>Register</a></p>
